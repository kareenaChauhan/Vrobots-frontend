...
import { ACCOUNT_REGISTER } from "../../../src/graphql/mutations/account";
...
const { login , user} = useAuthContext();
  const [registerUser, { loading }] = useMutation(ACCOUNT_REGISTER);
  useEffect(()=>{
    if (user) {
      navigate('/');
    }
      ...
      const { data } = await registerUser({
        variables: {
          input: {
            email,
            password,
            redirectUrl: "http://localhost:3000/email-confirm", 
  ...
  //   e.preventDefault();
  //   if (validateForm()) {
  //     console.log('Sign in:', { email, password, userName });
  //   }
  // };
        ...
        <div className="flex flex-col lg:flex-row min-h-[600px] lg:min-h-[700px] bg-white rounded-lg lg:rounded-none shadow-sm lg:shadow-none overflow-hidden">
          ...
          <div className="hidden lg:flex lg:flex-1 relative overflow-hidden">
            ...
            <div className="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
              <img
                src="https://mooncart.dexignzone.com/xhtml/images/registration/pic1.png"
          ...
          <div className="flex-1 lg:flex-1 flex items-center justify-center p-6 md:p-8 lg:p-16 bg-white ">
           ...
           { mailSend ? (
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Check your email</h2>
              <p className="text-gray-600 text-sm md:text-base">A confirmation email has been sent to {email}. Please check your inbox to confirm your account.</p>
            </div>
           ) : (
              <>
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">welcome please login to your account</h2>
                <p className="text-gray-600 text-sm md:text-base">Welcome please registration to your account</p>
              </div>
